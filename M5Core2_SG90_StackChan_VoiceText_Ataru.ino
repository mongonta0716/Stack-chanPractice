...
void setup() {
  ...
  setSpeedForAllServos(9);//サーボのスピード調整はこれ数字大で速度UP
  ...
  faces[0] = new DannFace();
  faces[1] = new DannFace();
...
#ifdef USE_VOICE_TEXT
char *text1 = "テストおしゃべりだぜ";
char *text2 = "テストお喋りだぜ";
char *text3 = "これもテストお喋りだぜー";
char *tts_parms1 ="&emotion_level=2&emotion=happiness&format=mp3&speaker=hikari&volume=50&speed=90&pitch=130";
char *tts_parms2 ="&emotion_level=1&emotion=happiness&format=mp3&speaker=hikari&volume=50&speed=80&pitch=130";
char *tts_parms3 ="&emotion_level=2&emotion=happiness&format=mp3&speaker=hikari&volume=50&speed=90&pitch=130";
